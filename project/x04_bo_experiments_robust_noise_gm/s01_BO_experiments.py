...
def parse_args() -> typing.Dict[str, typing.Any]:
    ...
    parser.add_argument(
        "--model_output_dir",
        default=pathlib.Path.home() / "BO" / "models" / "X04_gm",
    )
    parser.add_argument(
        "--noise_model",
    ...
    parser.add_argument("--mixture_scale", type=float, default=5.0) # c
